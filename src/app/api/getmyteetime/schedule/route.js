...
const SCHEDULE_NAME = process.env.GETMYTEETIME_SCHEDULE_NAME || "getmyteetime-schedule";
const GROUP_NAME = process.env.GETMYTEETIME_SCHEDULE_GROUP || undefined;
...
export async function GET() {
  try {
    ...
    console.error("Failed to get GetMyTeeTime schedule:", error);
    return Response.json(
...
export async function PUT(request) {
  try {
    ...
    await schedulerClient.send(
      new UpdateScheduleCommand({
        ...
        Target: {
          ...
          ...(typeof targetInput === "string" ? { Input: targetInput } : {}),
        },
    ...
    console.error("Failed to update GetMyTeeTime schedule:", error);
    return Response.json(
