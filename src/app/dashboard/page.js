...
import ERTeeTimeWidget from '@/components/ERTeeTimeWidget';
...
export default async function Dashboard() {
  ...
  return (
    <div className="mx-auto max-w-5xl px-6 py-12">
      ...
      <DashboardBotSections teeTimeWidget={<GetMyTeeTimeWidget />} erTeeTimeWidget={<ERTeeTimeWidget />} courtWidget={<GetMyCourtWidget />} />
    </div>
  );
}
