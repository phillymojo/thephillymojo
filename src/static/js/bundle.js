...
var _IndexPage = __webpack_require__(71);

var _AthletePage = __webpack_require__(73);

var _NotFoundPage = __webpack_require__(36);

var _athletes = __webpack_require__(37);
...
var renderAthlete = function renderAthlete(_ref) {
  ...
  if (!athlete) {
    return _react2.default.createElement(_NotFoundPage.NotFoundPage, { staticContent: staticContent });
  }
...
var _AthletePreview = __webpack_require__(72);
  ...
  _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      athletes.map(function (athleteData) {
        return _react2.default.createElement(_AthletePreview2.default, _extends({
          key: athleteData.id
        }, athleteData));
      })
    )
...
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; // src/components/AthletePage.js
...
var _AthletesMenu = __webpack_require__(74);

var _AthletesMenu2 = _interopRequireDefault(_AthletesMenu);

var _Medal = __webpack_require__(75);

var _Medal2 = _interopRequireDefault(_Medal);

var _Flag = __webpack_require__(76);
...
var AthletePage = exports.AthletePage = function AthletePage() {

  var id = undefined.props.params.id;
...
var AthletesMenu = exports.AthletesMenu = function AthletesMenu() {

  _react2.default.createElement(
    'nav',
    { className: 'athletes-menu' },
    undefined.props.athletes.map(function (menuAthlete) {
      return _react2.default.createElement(
        _reactRouter.Link,
...
var Medal = exports.Medal = function Medal() {
  ...
  _react2.default.createElement(
    ...
    _react2.default.createElement(
      'span',
      { className: 'symbol symbol-' + undefined.props.type, title: typeMap[undefined.props.type] },
      undefined.props.type
    ),
    _react2.default.createElement(
      'span',
      { className: 'year' },
      undefined.props.year
    ),
    _react2.default.createElement(
      'span',
      { className: 'city' },
      ' ',
      undefined.props.city
    ),
    _react2.default.createElement(
      'span',
      { className: 'event' },
      ' (',
      undefined.props.event,
      ')'
    ),
    _react2.default.createElement(
      'span',
...
var Flag = exports.Flag = function Flag() {

  var name = data[undefined.props.code].name;
  var icon = data[undefined.props.code].icon;
  return _react2.default.createElement(
    'span',
    { className: 'flag' },
    _react2.default.createElement('img', { className: 'icon', title: name, src: '/img/' + icon }),
    undefined.props.showName && _react2.default.createElement(
      'span',
      { className: 'name' },
      ' ',
      name
...
*/
var aa=__webpack_require__(0),l=__webpack_require__(38),B=__webpack_require__(6),C=__webpack_require__(5),ba=__webpack_require__(39),da=__webpack_require__(40),ea=__webpack_require__(41),fa=__webpack_require__(42),ia=__webpack_require__(43),D=__webpack_require__(10);
